About rfc5424-logging-handler-feedstock
=======================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/rfc5424-logging-handler-feedstock/blob/main/LICENSE.txt)
...
Documentation: https://rfc5424-logging-handler.readthedocs.org/
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7183&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/rfc5424-logging-handler-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `rfc5424-logging-handler` can be installed with `conda`:
...
```
mamba install rfc5424-logging-handler
```

It is possible to list all of the versions of `rfc5424-logging-handler` available on your platform with `conda`:
...
```
mamba search rfc5424-logging-handler --channel conda-forge
```
...
mamba repoquery search rfc5424-logging-handler --channel conda-forge

# List packages depending on `rfc5424-logging-handler`:
mamba repoquery whoneeds rfc5424-logging-handler --channel conda-forge

# List dependencies of `rfc5424-logging-handler`:
mamba repoquery depends rfc5424-logging-handler --channel conda-forge
```
